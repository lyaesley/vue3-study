<template>
  <div>
    <!-- v-on:chagne or @change 사용 가능 -->
    <select name="" id="" @change="changCity($event)" v-model="selectedCity">
  ...
  data() {
    return {
      ...
      dongList: [
        ...
        { cityCode: '063', dongCode: '1', dongTitle: '제주 1동' },
        { cityCode: '063', dongCode: '2', dongTitle: '제주 2동' }
      ],
      selectedDongList: []
    }
  },
